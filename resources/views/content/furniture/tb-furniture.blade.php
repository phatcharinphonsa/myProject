...
<section class="app-user-list">
    ...
    <div class="card">
        <div class="card-body border-bottom">
            <h4 class="card-title">เพิ่มข้อมูลเฟอร์นิเจอร์</h4>
            <div class="row">
        ...
        <div class="card-datatable table-responsive pt-0">
            <table class="user-list-table table">
                <thead class="table-light">
                    <tr>
                        <th></th>
                        <th>รหัสเฟอร์นิเจอร์</th>
                        <th>ชื่อ</th>
                        <th>ราคา</th>
                        <th>รหัสประเภทเฟอร์นิเจอร์</th>
                        <th>จัดการ</th>
                    </tr>
                </thead>
            </table>
            ...
            <div class="modal-dialog">
                <form class="add-new-user modal-content pt-0">
                    ...
                    <div class="modal-header mb-1">
                        <h5 class="modal-title" id="exampleModalLabel">เพิ่มข้อมูลเฟอร์นิเจอร์</h5>
                    </div>
                    <div class="modal-body flex-grow-1">
                        ...
                        <div class="mb-1">
                            <label class="form-label" for="basic-icon-default-uname">ราคา</label>
                            <input type="text" id="basic-icon-default-uname" class="form-control dt-uname"
                                placeholder=" " name="user-name" />
                        </div>
                        <div class="mb-1">
                            <label class="form-label" for="basic-icon-default-uname">จัดการ</label>
                            <input type="text" id="basic-icon-default-uname" class="form-control dt-uname"
                                placeholder=" " name="user-name" />
                        </div>
