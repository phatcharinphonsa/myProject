...
<div class="card mb-4">
    <h5 class="card-header">แบบฟอร์มเพิ่มข้อมูลร้านตัวแทนจำหน่าย</h5>
    <form class="card-body">
        <div class="row g-3">
            <div class="col-md-6">
                <label class="form-label" for="multicol-username">รหัสร้านตัวแทน</label>
                <input type="text" id="multicol-username" class="form-control" />
            </div>
            <div class="col-md-6">
                <label class="form-label" for="multicol-email">ชื่อร้านตัวแทน</label>
                <input type="text" id="multicol-username" class="form-control" />
            </div>
            <div class="col-md-6">
